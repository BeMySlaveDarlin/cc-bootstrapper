...
Agent(name="analyst", team_name=T)
  → SendMessage(to="lead", summary="done + diagnosis path", message="done + diagnosis path")
Gate: review
...
Agent(name="{lang}-reviewer", team_name=T)
  {lang}-developer → SendMessage(to="{lang}-test-developer", summary="done", message="done")
