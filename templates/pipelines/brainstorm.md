...
Agent(name="analyst", team_name=T)
  → SendMessage(to="lead", summary="done + frame path", message="done + frame path")
Gate: review
...
Agent(name="{lang}-architect", team_name=T)
  ...
  analyst → SendMessage(to="{lang}-architect", summary="perspective", message="perspective")
  storage-architect (если спавнен) → SendMessage(to="{lang}-architect", summary="perspective", message="perspective")
  devops (если спавнен) → SendMessage(to="{lang}-architect", summary="perspective", message="perspective")
  {lang}-architect: consolidate все полученные perspectives → SendMessage(to="lead", summary="options path", message="options path")
Gate: review
