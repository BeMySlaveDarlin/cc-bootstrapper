...
- Early returns
- **Нет дублирования кода — ПРОВЕРЬ через Grep/Glob**: если новый хелпер/утилита/сервис похож на существующий в другом модуле → BLOCK с рекомендацией переиспользовать
